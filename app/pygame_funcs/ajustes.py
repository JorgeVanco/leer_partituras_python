...
def draw_menu(menu, screen, AJUSTES, AJUSTES_DEFAULT, complete_path):
    ...
    menu.add.range_slider("Porcentaje para diferenciar negras de blancas: "+str(AJUSTES.PORCENTAJE_DIFERENCIAR_NEGRA_BLANCA), default=AJUSTES.PORCENTAJE_DIFERENCIAR_NEGRA_BLANCA, range_values=(0, 1), increment=0.1, onchange = lambda value:set_porcentaje_diferenciar_negra_blanca(value, AJUSTES))
